...
class CartController extends GetxController {
  ...
  void getToProductDetail(Product product){
    Get.toNamed('/menu/${product.id}', arguments: product);
  }
  ...
  void addProduct(Product product) {
    ...
    Get.snackbar('${product.name} è stato aggiunto!',
        ...
        backgroundColor:
            themeController.isSwitched ? Colors.white : Colors.grey.shade900,
        colorText: themeController.isSwitched ? Colors.black : Colors.white);
